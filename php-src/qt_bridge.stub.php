...
/**
 * Set the UI language by loading a Qt translation file.
 * Loads translations/qt_<code>.qm (Qt framework translations) if present.
 * Supported codes: en, zh_CN, zh_TW, ja, ko, fr, de, ru, ...
 */
function qt_app_set_language(string $code): void {}
